...
const SummaryBox = ({ summaryText }: { summaryText: string }) => {
  return (
    <div className="w-full flex-shrink-0 px-5 py-3 rounded-[10px] outline outline-1 outline-offset-[-1px] outline-zinc-300 justify-center items-start gap-[5px] overflow-hidden">
